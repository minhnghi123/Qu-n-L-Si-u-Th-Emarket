...
namespace QuanLySieuThi
{
    class chuoiketnoi
    {
        public static string sqlcon = "Data Source=ALIEN\\SQLEXPRESS;Initial Catalog=QuanLySieuThi;Integrated Security=True;Encrypt=True;Trust Server Certificate=True";
